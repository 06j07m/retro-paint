...
- **Painting tools**
  ...
  <img src="display/screenshot-toolds.png" alt="screenshot closeup of tool selection box" width=50%/>
...
- **Other tools**
  ...
  <img src="display/screenshot-file.png" alt="screenshot closeup of save/undo/clear" width=50%/>
...
- **6 stamps & 6 backgrounds**
  ...
  <img src="display/screenshot-stamps.png" alt="screenshot closeup of stamp and background selector" width=50%/>
...
- **Music**
  ...
  <img src="display/screenshot-music.png" alt="screenshot closeup of music player" width=50%/>
...
- **Misc**
  ...
  <img src="display/screenshot-tooloptions.png" alt="screenshot closeup of colour/fill selector" width=50%/>
  ...
  <img src="display/screenshot-slider.png" alt="screenshot closeup of brush size slider" width=50%/>
